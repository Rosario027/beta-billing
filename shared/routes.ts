...
export const api = {
  ...
  customers: {
    list: {
      method: 'GET' as const,
      path: '/api/clients/:clientId/customers',
      responses: {
  ...
  invoices: {
    list: {
      method: 'GET' as const,
      path: '/api/clients/:clientId/invoices',
      responses: {
    ...
    get: {
      ...
      responses: {
        200: z.any(), // TODO: Strongly type the invoice with items response
        404: errorSchemas.notFound,
      },
    },
    create: {
    ...
    update: {
      method: 'PUT' as const,
      path: '/api/invoices/:id',
      input: createInvoiceSchema.partial(),
      responses: {
